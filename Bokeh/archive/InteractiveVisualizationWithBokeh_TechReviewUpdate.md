...
After you create your figure you are given access to [a bevy of configurable glyph methods](https://bokeh.pydata.org/en/latest/docs/reference/plotting.html).
